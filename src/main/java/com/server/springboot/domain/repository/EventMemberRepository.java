...
public interface EventMemberRepository extends JpaRepository<EventMember, Long> {
    ...
    boolean existsByEventMemberAndEvent(User user, Event event);
    ...
    List<EventMember> findAllByEventMemberInAndAddedInIsGreaterThan(List<User> users, LocalDateTime dateLimit);
}
